...
**126.（单选题）** 下列有关审计工作底稿的说法中，错误的是（　）。

A. 审计工作底稿的所有权属于会计师事务所
B. 审计证据的载体是审计工作底稿
C. 审计工作底稿中仅记录获取的审计证据及形成的审计结论
D. 审计工作底稿并不能代替被审计单位的会议记录

**127.（单选题）** 下列各项中，不属于注册会计师编制审计工作底稿的目的的是（　）。

A. 保留对未来审计工作持续产生重大影响的事项的记录
B. 有助于为涉及诉讼的被审计单位提供证据
C. 便于监管机构对会计师事务所实施执业质量检查
D. 便于会计师事务所按照规定实施项目质量复核

**128.（单选题）** 注册会计师编制的审计工作底稿，应当使得未曾接触该项审计工作的有经验的专业人士清楚了解相关事项，下列各项中，不属于相关事项的是（　）。
...
**129.（单选题）** 下列各项因素中，注册会计师在确定审计工作底稿的格式、要素和范围时通常无需考虑的是（　）。
...
**130.（单选题）** 会计师事务所应当针对审计工作底稿设计和实施适当的控制。下列各项中，通常不属于控制目的的是（　）。
...
**131.（单选题）** 下列有关识别特征的说法中，错误的是（　）。

A. 在对被审计单位生成的订购单进行细节测试时，注册会计师可能以订购单的日期和编号作为测试订购单的识别特征
B. 对于需要选取或复核既定总体内一定金额以上的所有项目的审计程序，注册会计师可以以金额作为识别特征
C. 对于需要询问被审计单位中特定人员的审计程序，注册会计师可能会以询问的时间、被询问人的姓名以及职位作为识别特征
D. 对于观察程序，注册会计师仅以观察的对象作为识别特征

**132.（单选题）**（2024年）在记录实施审计程序的性质、时间安排和范围时，注册会计师应当记录测试的具体项目或事项的识别特征。下列各项中，不属于记录识别特征的目的的是（　）。
...
**135.（单选题）** 组成部分注册会计师为集团审计目的出具审计报告的日期为2025年2月14日，集团项目组出具集团审计报告的日期为2025年3月8日。下列有关组成部分注册会计师的审计工作底稿保存期限的说法中，正确的是（　）。

A. 应当自2025年2月15日起至少保存十年
B. 应当自2025年2月14日起至少保存十年
C. 应当自2025年3月8日起至少保存十年
D. 应当自2025年3月9日起至少保存十年

**136.（多选题）** 下列有关注册会计师对审计工作底稿作出变动的做法中，正确的有（　）。

A. 注册会计师应在审计工作底稿中记录在审计过程中对具体审计计划作出的任何重大修改和理由
B. 在归档期间记录在审计报告日前获取的、与项目组相关成员进行讨论并达成一致意见的审计证据
C. 以归档期间收到的询证函回函替换审计报告日前已实施的替代程序审计工作底稿
D. 在归档后由于实施追加的审计程序而修改审计工作底稿，记录修改的理由、时间和人员，以及复核的时间和人员

**137.（多选题）** 在编制审计工作底稿时，下列各项中，注册会计师通常认为需要形成最终审计工作底稿的有（　）。

A. 注册会计师与被审计单位管理层对重大事项进行讨论的结果
B. 注册会计师记录的有关存货监盘审计程序或审计过程中发现问题的备忘录
C. 注册会计师记录的被审计单位本年各月收入与上一年度的同期数据进行比较的情况
D. 注册会计师取得的存在印刷错误或其他错误作废的文本

**138.（多选题）** 在完成最终审计档案的归整工作后，如果发现有必要修改现有审计工作底稿或增加新的审计工作底稿，无论修改或增加的性质如何，注册会计师均应当记录的内容有（　）。

A. 实施项目质量复核的人员
B. 修改或增加审计工作底稿的理由
C. 修改或增加审计工作底稿的时间和人员
D. 复核变动后的审计工作底稿的时间和人员

**139.（多选题）** 下列有关审计工作底稿的归档和保存的说法中，正确的有（　）。

A. 在归档期间，注册会计师可以对审计工作底稿进行分类、整理和交叉索引
B. 如果注册会计师未能完成审计业务，会计师事务所应当自审计业务中止日起，对审计工作底稿至少保存10年
C. 注册会计师应当自财务报表批准日起60天内将审计工作底稿归档
D. 如果针对客户的同一财务信息执行不同的委托业务，出具两个或多个不同的报告，会计师事务所应当以最后一项业务完成日为准，在归档期限内归整为最终审计档案

**140.（多选题）** 下列有关审计工作底稿的说法中，正确的有（　）。

A. 审计工作底稿的所有权属于会计师事务所
B. 会计师事务所应当自审计报告日起，对审计工作底稿至少保存10年
C. 在完成最终审计档案的归整工作后，注册会计师不应删除或废弃任何性质的审计工作底稿
D. 如果注册会计师未能完成审计业务，则无需归档审计工作底稿

**141.（多选题）**（2024年）下列各项中，属于注册会计师编制审计工作底稿的主要目的的有（　）。
...
**142.（多选题）**（2023年）下列各项中，属于注册会计师在归档期间对审计工作底稿作出的事务性变动的有（　）。
...
**143.（简答题）** ABC会计师事务所的A注册会计师负责审计甲公司2024年度财务报表。与审计工作底稿相关的部分事项摘录如下：

（1）因在测试材料采购相关控制时发现控制未得到有效执行，A注册会计师将材料采购的审计方案由综合性方案改为实质性方案，并重新编制审计计划工作底稿，删除了被取代的原审计计划的工作底稿。
...
**144.（简答题）** ABC会计师事务所的A注册会计师负责审计多家被审计单位2024年度财务报表。与审计工作底稿相关的部分事项如下：

（1）因无法获取充分、适当的审计证据，A注册会计师在2025年2月29日中止了甲公司2024年度财务报表审计业务。考虑到该业务可能重新启动，A注册会计师未将审计工作底稿归档。

（2）A注册会计师在出具乙公司2024年度审计报告日次日收到一份应收账款询证函回函，确认金额无误后将其归入审计工作底稿，未删除记录替代程序的原审计工作底稿。
...
**单选题**：126.C（审计工作底稿是对制定的审计计划、实施的审计程序、获取的审计证据和审计结论的记录，并不仅仅记录审计证据和审计结论）　127.B（有助于为涉及诉讼的被审计单位提供证据不属于编制审计工作底稿的目的）　128.D（审计收费金额以及收费标准不属于应当使有经验的专业人士清楚了解的相关事项）　129.A（确定审计工作底稿的格式、要素和范围时需要考虑的是拟实施审计程序的"性质"等因素，无需考虑审计程序的范围）　130.C（即使经过授权，在审计工作底稿归档后保存期限届满前也不得删除审计工作底稿，故"防止归档后未经授权删除"并非控制的正确目的）　131.D（对于观察程序，注册会计师可以以观察的对象或观察过程、相关被观察人员及其各自的责任、观察的地点和时间作为识别特征，并非仅以观察对象）　132.C（记录识别特征便于对例外事项进行调查、对测试的项目进行复核，并能反映项目组履行职责的情况，与"便于在总体中选取测试项目"无关）　133.B（在完成最终审计档案的归整工作后，注册会计师不应在规定的保存期届满前删除或废弃任何性质的审计工作底稿，经批准也不得删除）　134.D（审计工作底稿通常包括标题、审计过程记录、审计结论、审计标识及其说明、索引号及编号、编制者姓名及编制日期、复核者姓名及复核日期等要素，不包括执行质量检查的检查人员的姓名及时间）　135.C（集团项目组针对集团财务报表出具审计报告的日期为2025年3月8日，其中包括对组成部分注册会计师审计工作结果的利用，故组成部分审计工作底稿应自集团审计报告日起至少保存十年）

**多选题**：136.ABD（C以归档期间收到的询证函回函替换审计报告日前已实施的替代程序审计工作底稿是错误的，替代程序是审计报告日前应完成的必要审计程序，相关审计工作底稿不能被审计报告日后收到的回函替换，应同时保存）　137.ABC（审计工作底稿通常不包括已被取代的底稿草稿或财务报表的草稿、反映不全面或初步思考的记录、存在印刷错误或其他错误而作废的文本以及重复的文件记录，选项D不应形成最终审计工作底稿）　138.BCD（归档后修改或增加审计工作底稿时，注册会计师应当记录修改或增加的理由、修改或增加的时间和人员，以及复核的时间和人员，选项A实施项目质量复核的人员不属于应当记录的内容）　139.AB（C审计工作底稿的归档期限为审计报告日后60天内，并非自财务报表批准日起；D针对客户的同一财务信息执行不同的委托业务、出具两个或多个不同的报告，应当将其视为不同的业务，分别在规定的归档期限内归整为最终审计档案，而非以最后一项业务完成日为准）　140.AB（C在完成最终审计档案的归整工作后，注册会计师不应在规定的保存期届满前删除或废弃任何性质的审计工作底稿，保存期届满后可以删除，选项C表述过于绝对；D如果未能完成审计业务，审计工作底稿也应进行归档，归档期限为审计业务中止后的60天内）　141.BCD（A便于后任注册会计师查阅不属于编制审计工作底稿的目的）　142.ACD（B将审计报告日后获取的管理层签署的书面声明归入审计工作底稿属于新获取的审计证据，不属于事务性变动）

**简答题**：

**143.（简答题）**（1）不恰当。应当在审计工作底稿中记录对审计计划作出的重大修改及其理由。（2）不恰当。对订单而言，供应商名称不具有唯一性，不适合作为识别特征。（3）恰当。（4）不恰当。替代程序是审计报告日前应完成的必要审计程序，相关审计工作底稿不能删除。（5）不恰当。还应记录复核的时间和人员。

**144.（简答题）**（1）不恰当。应在业务中止后的60天内归档/业务中止也应归档。（2）恰当。（3）不恰当。会计师事务所应当自审计报告日起对审计工作底稿至少保存10年/在规定保存期届满前，不应删除或废弃任何性质的审计工作底稿。（4）不恰当。注册会计师应当记录对已归档审计工作底稿的修改或增加/应当记录修改或增加审计工作底稿的理由、时间和人员，以及复核的时间和人员。（5）不恰当。应当记录实施的具体程序/应当记录阅读和考虑其他信息的程序。
