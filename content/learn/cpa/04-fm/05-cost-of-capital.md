...
**11.（单选题）** (2024年) 甲公司拟发行非上市交易的10年期公司债券，信用等级为A，目前市场上有剩余期限10年的国债，到期收益率3.6%，预计未来通货膨胀率2%。A级债券的信用风险溢价1.3%，非上市交易债券流动风险溢价1.7%。债券平价发行，甲公司该债券的票面利率为（　）。
...
**12.（单选题）** (2022年) 甲公司是一家传统制造业企业，拟投资新能源汽车项目，预计期限10年。乙公司是一家新能源汽车制造企业，与该项目具有类似的商业模式、规模、负债比率和财务状况。下列各项中，最适合作为该项目税前债务资本成本的是（　）。
...
**13.（单选题）** (2021年) 甲公司拟发行优先股筹资，发行费用率和年股息率分别为2%和8%，每半年支付一次股利，企业所得税税率25%。根据税法规定，该优先股股利不能抵税。该优先股资本成本为（　）。
...
**14.（单选题）** (2020年) 甲公司采用债券收益率风险调整模型估计股权资本成本，税前债券资本成本8%，股权相对债权风险溢价6%，企业所得税税率25%。甲公司的股权资本成本是（　）。
...
**15.（单选题）** (2019年) 甲公司有X、Y两个项目组，分别承接不同的项目类型，X项目组的资本成本为10%，Y项目组的资本成本为14%，甲公司资本成本为12%。下列项目中，甲公司可以接受的是（　）。
...
**16.（多选题）** (2024年) 企业目前资金来源为1000万元，其中债券300万元，税前资本成本6%；优先股200万元，年股息率7%（分类为权益工具，平价发行，不考虑发行费用）；普通股500万元。企业所得税税率25%，无风险利率3%，β系数为1.2，股票市场风险溢价为6%，股权资本成本按照资本资产定价模型确定。以下说法正确的有（　）。
...
**17.（多选题）** (2023年) 甲公司目前没有上市交易的债券，在测算公司债务资本成本时，下列表述正确的有（　）。

A. 采用可比公司法时，可比公司应与甲公司的商业模式、财务状况类似
B. 采用可比公司法时，可比公司与甲公司在同一行业且拥有上市交易的债券
C. 采用风险调整法时，用来估计无风险收益率的政府债券应与甲公司债券到期日相同或相近
D. 采用风险调整法时，用来估计信用风险补偿率的发债公司应与甲公司在同一行业

**18.（多选题）** (2021年) 公司资本成本的影响因素有（　）。
...
**19.（多选题）** (2018年) 采用实体现金流量模型进行企业价值评估时，为了计算资本成本，无风险利率需要使用实际利率的情况有（　）。
...
**练习答案**：1.C　2.B（税前 $r_d \approx 6.7\%$，税后 $6.7\% \times 0.75 \approx 5.0\%$）　3. (1) $r_s = 3\% + 1.1 \times (11\%-3\%) = 11.8\%$；(2) $r_s = 1.5 \times 1.04/20 + 4\% = 7.8\% + 4\% = 11.8\%$　4. WACC $= 30\% \times 6\% \times 0.75 + 10\% \times 9\% + 60\% \times 13\% = 1.35\% + 0.9\% + 7.8\% = 10.05\%$　5.ABC　6. $r_p = 7/(100 \times 0.96) = 7/96 = 7.29\%$　7.B（折价债券 YTM > 票面利率）　8. $r_s = 2 \times 1.06/(25 \times 0.96) + 6\% = 2.12/24 + 6\% = 8.83\% + 6\% = 14.83\%$　9.D（债务资本成本受所得税影响，税后 = 税前 × (1-T)）　10. WACC $= 40\% \times 7\% \times 0.75 + 60\% \times 12\% = 2.1\% + 7.2\% = 9.3\%$；NPV $= 130 \times (P/A, 9.3\%, 5) - 500 = 130 \times 3.8397 - 500 = 499.16 - 500 = -0.84$ 万元 < 0，项目不可行。　11.A（平价发行则票面利率 = 税前资本成本 = 国债到期收益率 + 信用风险溢价 + 流动风险溢价 = 3.6% + 1.3% + 1.7% = 6.6%；国债到期收益率已含通胀，无需再加2%）　12.A（用可比公司法，以可比公司长期债券的到期收益率作为长期债务税前资本成本）　13.D（半年股息率 = 8%/2 = 4%；半年资本成本 = 4%/(1−2%) = 4.08%；年资本成本 = (1+4.08%)² − 1 = 8.33%；注意优先股股利不能抵税）　14.C（股权资本成本 = 税后债务资本成本 + 风险溢价 = 8%×(1−25%) + 6% = 6% + 6% = 12%）　15.B（项目应采用自身资本成本评价：X类项目报酬率11% > 10%可行；Y类项目报酬率13% < 14%不可行）　16.AD（股权资本成本 = 3% + 1.2×6% = 10.2%，C错；WACC = 6%×(1−25%)×30% + 7%×20% + 10.2%×50% = 1.35% + 1.4% + 5.1% = 7.85%，D正确；无风险利率上升1%→股权成本上升1%→WACC上升50%×1% = 0.5个百分点，A正确；债券税前成本上升1%→WACC上升30%×1%×0.75 = 0.225个百分点，B错）　17.ABC（风险调整法确定信用风险补偿率时，应选择信用级别与本公司相同的上市公司债券，不要求同行业，D错）　18.ABCD（资本成本取决于无风险利率、经营风险溢价和财务风险溢价；负债率影响财务风险，外部市场投资报酬率影响公司资本成本）　19.AD（只有存在恶性通胀或预测周期特别长时才用实际利率）　20.ABC（财务比率法是计算债务资本成本的方法，D错）
