**练习答案**：1.B（$\max(40-35,0) - 3 = 5 - 3 = 2$）　2.B　3. $C_u=2, C_d=0, p=(1.05-0.8)/(1.2-0.8)=0.625, C_0=(0.625\times2+0.375\times0)/1.05=1.19$元　4. $P_0 = 6 + 50/1.08 - 50 = 6 + 46.30 - 50 = 2.30$元　5.ABCD　6. 组合价值$=\max(S_T, 48)$，成本$=54$元；$S_T=60$: 损益$=60-54=6$元；$S_T=48$: 损益$=48-54=-6$元；$S_T=40$: 损益$=48-54=-6$元；最大亏损$=48-54=-6$元　7.A（内在价值$=\max(35-30,0)=5$，时间溢价$=6-5=1$）　8. $C_u=8, C_d=0$；$H=(8-0)/(48-32)=0.5$；$B=(0.5\times32-0)/1.02=15.69$；$C_0=0.5\times40-15.69=20-15.69=4.31$元　9.C（美式期权可在到期日前执行，灵活性更高，价值通常≥欧式）　10. $P_0=8+60/1.06-60=8+56.60-60=4.60$元；市场报价5元>理论价值4.60元，存在套利机会（卖出看跌期权获利）　11.A（欧式期权只能在到期日（11月26日）行权；看跌期权在股票市价低于执行价格18元时行权，故11月26日股价15元时行权）　12.A（复制多头看涨期权需购入股票并借入款项，排除CD；套期保值比率 $H=(C_u-C_d)/(S_u-S_d)=(80-65-0)/(80-50)=15/30=0.5$，即购入0.5股股票）　13.B（股票投资净损益$=(105-85)\times100=2000$元；到期股价105元>执行价格90元，期权持有者行权，乙每份期权净损益$=90-105+8=-7$元，共$-700$元；总净损益$=2000-700=1300$元）　14.A（看涨期权到期日价值$=64-60=4$元；看跌期权执行价格60元<到期股价64元，不行权，价值为0；组合净损益$=4+0-5-3=-4$元）　15.D（股价波动率越大，时间溢价越大，期权价值越大；执行价格上升使看涨期权价值下降，无风险利率和股票市价上升均使看跌期权价值下降）　16.AC（实物期权的价值不可能为负数，其存在不会降低项目价值，A错；延迟期权与扩张期权一样属于看涨期权，C错；放弃期权是看跌期权，B、D表述正确）　17.AB（降低执行价格提高看涨期权内在价值；无风险利率上升使执行价格现值降低，从而增加看涨期权价值；缩短到期期限和股价波动率下降均使期权价值下降）　18.BD（美式期权只要未到期，时间溢价就大于0，故A、C错；虚值期权执行的现金净流入为负，不会被理性投资者执行；未到期的实值期权可等到期日执行，不一定会被立即执行）　19.AD（内在价值$=60-50=10$元，时间溢价$=12-10=2$元；欧式期权只能在到期日行权，目前不能执行；题目未告知到期日股价，无法判断到期时是否执行；市价高于执行价格，处于实值状态）　20.AD（X期权内在价值$=20-15=5$元；Y期权未到期，时间溢价大于0，B错；股价上涨5元至25元时Y期权仍为平值，内在价值仍为0，期权价值不会上涨5元，C错；X、Y期权到期日相同即时间溢价相同，而X内在价值更高，故X期权价值高于Y期权）
