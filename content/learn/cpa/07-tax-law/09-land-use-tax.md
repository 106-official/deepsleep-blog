...
| 购置存量房 | 房屋权属证书签发之**次月**起 |
| 出租、出借房产 | 交付出租、出借房产之**次月**起 |
| 新征收的耕地 | 批准征收之日起满 **1 年**时 |
| 新征收的非耕地 | 批准征收之**次月**起 |
| 招标、拍卖、挂牌取得建设用地 | 合同约定交付土地时间之**次月**起（未约定的为合同签订之次月起） |
| 出让或转让方式有偿取得土地使用权 | 受让方自合同约定交付土地时间之**次月**起（未约定的为合同签订之次月起） |
| 因土地权利变化终止纳税义务 | 应纳税款计算截止到土地权利发生变化的**当月末** |
...
| 序号 | 减征项目 | 税额 |
|------|----------|------|
| 1 | 铁路线路、公路线路、飞机场跑道、停机坪、港口、航道、水利工程占用耕地 | 减按每平方米 **2 元**征收 |
| 2 | 农村居民在规定用地标准内占用耕地新建自用住宅 | 按当地适用税额**减半**征收 |
...
| 情形 | 纳税义务发生时间 |
|------|------------------|
| 经批准占用耕地 | 收到自然资源主管部门办理占用耕地手续的书面通知的**当日** |
...
| 情形 | 退税条件 |
|------|----------|
| 临时占用耕地 | 批准临时占用期满之日起 **1 年内**依法复垦，恢复种植条件的，全额退还 |
| 损毁耕地 | 自认定损毁之日起 **3 年内**依法复垦或修复，恢复种植条件的，可按规定办理退税 |
...
1. 下列各项中，不属于城镇土地使用税征税范围的是（ ）。
   A. 城市的土地
   B. 县城的土地
   C. 建制镇的土地
   D. 农村的土地

2. 某企业占用土地 5,000 平方米，每平方米年税额为 4 元，全年应纳城镇土地使用税（ ）。
   A. 10,000 元
   B. 20,000 元
   C. 15,000 元
   D. 25,000 元

3. 经济落后地区城镇土地使用税适用税额标准降低的，降低额不得超过规定最低税额的（ ）。
   A. 20%
   B. 30%
   C. 40%
   D. 50%

4. 占用基本农田的，应当按当地适用税额加按（ ）征收耕地占用税。
   A. 50%
   B. 100%
   C. 150%
   D. 200%

5. 农村居民在规定用地标准以内占用耕地新建自用住宅，按照当地适用税额（ ）征收耕地占用税。
   A. 免征
   B. 减半
   C. 减按 30%
   D. 减按 70%

6. 纳税人新征收的耕地，自批准征收之日起满（ ）时开始缴纳城镇土地使用税。
   A. 3 个月
   B. 6 个月
   C. 1 年
   D. 2 年

7. 铁路线路占用耕地，减按每平方米（ ）元的税额征收耕地占用税。
   A. 1
   B. 2
   C. 3
   D. 5
...
1. 下列关于城镇土地使用税纳税人的说法，正确的有（ ）。
   A. 拥有土地使用权的单位和个人为纳税人
   B. 拥有人不在土地所在地的，其代管人或实际使用人为纳税人
   C. 土地使用权未确定的，实际使用人为纳税人
   D. 土地使用权共有的，共有各方都是纳税人
   E. 承租集体所有建设用地的，由直接承租人缴纳
...
3. 下列关于耕地占用税的说法，正确的有（ ）。
   A. 耕地占用税实行一次性征收
   B. 占用基本农田按当地适用税额加按 150% 征收
   C. 农村居民新建自用住宅按当地适用税额减半征收
   D. 铁路线路占用耕地减按每平方米 2 元征收
   E. 占用耕地建设农田水利设施的不缴纳耕地占用税

4. 下列占用耕地的情形中，免征耕地占用税的有（ ）。
   A. 军事设施占用耕地
   B. 学校占用耕地
   C. 医疗机构占用耕地
   D. 铁路线路占用耕地
   E. 农村烈士遗属在规定用地标准内新建自用住宅

5. 下列关于城镇土地使用税纳税义务发生时间的说法，正确的有（ ）。
   A. 购置新建商品房，自房屋交付使用之次月起缴纳
   B. 购置存量房，自房屋权属证书签发之次月起缴纳
   C. 出租、出借房产，自交付出租、出借房产之次月起缴纳
   D. 新征收的耕地，自批准征收之日起满 1 年时开始缴纳
   E. 新征收的非耕地，自批准征收次月起缴纳

### 三、计算题

1. 某城市企业 2026 年拥有土地使用情况如下：
   - 实际占用应税土地面积 8,000 平方米，每平方米年税额 5 元；
   - 另有一处地下建筑用地，未取得地下土地使用权证，按垂直投影面积计算为 1,500 平方米。
   
   计算该企业 2026 年全年应纳城镇土地使用税。

2. 某企业占用耕地 50,000 平方米建设厂房，其中占用基本农田 10,000 平方米，当地耕地占用税适用税额为 20 元/平方米。计算该企业应纳耕地占用税。

### 参考答案

**一、单选题**：1.D  2.B  3.B  4.C  5.B  6.C  7.B

**二、多选题**：1.ABCDE  2.ABCD（E 为附设营业单位用地应照章征税）  3.ABCDE  4.ABCE（D 为减征非免征）  5.ABCDE

**三、计算题**：

1. ① 地面土地应纳税额 = 8,000 × 5 = **40,000（元）**
   
   ② 地下建筑用地按应征税款的 50% 征收：
   
   应纳税额 = 1,500 × 5 × 50% = **3,750（元）**
   
   全年应纳城镇土地使用税合计 = 40,000 + 3,750 = **43,750（元）**

2. ① 占用一般耕地应纳税额 =（50,000 - 10,000）× 20 = 40,000 × 20 = **800,000（元）**
   
   ② 占用基本农田应纳税额 = 10,000 × 20 × 150% = **300,000（元）**
   
   应纳耕地占用税合计 = 800,000 + 300,000 = **1,100,000（元）**

<div class="learn-placeholder">
  <div class="learn-placeholder-icon">🌱</div>
  <p>本章节为城镇土地使用税与耕地占用税专题，"差别定额税率"和"耕地占用税一次性征收"是两大核心考点。</p>
</div>
