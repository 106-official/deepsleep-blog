...
| 9 | 未履行的应税合同、产权转移书据 | 已缴纳的印花税不予退还及抵缴 |
| 10 | 多贴的印花税票 | 不予退税及抵缴 |
...
### 口诀 8：境外书立在境内使用
> 境外书立境内使用，四类情形要缴纳；不动产所在地使用，金融交易境内使用，在境内使用的其他凭证，境内单位个人使用。

### 口诀 9：不属于征税范围
> 调整人身关系凭证，管理权利凭证；通知/声明/启事类，三类不在征税中。

### 口诀 10：合同税率归类
> 借款融资零点五，买卖承揽建设运输技术三，租赁保管仓储财保一，合同税率要记牢。

### 口诀 11：变更金额处理
> 变更金额要补退，增加金额补缴税；减少金额可退还，但以原税为上限。

### 口诀 12：应纳税额不足一角
> 应纳税额不足一角免，一角以上四舍五入；尾数不够一分钱，四舍五入到分位。

<div class="learn-placeholder">
  <div class="learn-placeholder-icon">印花税</div>
  <p>本章节为印花税专题，"税目税率表"和"计税依据不含增值税"是两大核心考点。</p>
</div>
