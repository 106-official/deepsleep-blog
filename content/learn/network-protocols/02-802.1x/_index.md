...
>
> **⚠️ 初学者最常踩的坑**：把"网线插上、链路灯亮着，却拿不到 IP"当成 DHCP 故障去查。实际上这正是 802.1X 环境**最典型**的正常表现——认证通过前端口处于非授权状态，除 EAPOL 外的一切帧（含 ARP、DHCP、IP）全部被丢弃。排查方向应该是先看有没有 EAPOL 帧，而不是去翻 DHCP 服务器。
