...
### 2.2 Echo Request / Reply（Type 8 / 0）——ping 的核心
...
### 2.4 ICMPv6 关键 Type（RFC 4443 及相关）

ICMPv6 用**最高位**区分类别：**Type 0–127 为差错报文，128–255 为信息报文**。
