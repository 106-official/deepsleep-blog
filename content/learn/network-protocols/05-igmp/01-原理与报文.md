...
IPv4 组播使用 **D 类地址 `224.0.0.0/4`**（224.0.0.0 – 239.255.255.255）：
...
所有 IGMP 报文封装于 IP，**Protocol = 2，TTL = 1，携带 Router Alert 选项**。

### 2.1 IGMPv1（RFC 1112）——8 字节
