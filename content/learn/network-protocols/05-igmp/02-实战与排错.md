...
ip igmp snooping vlan 10 querier                 ! ★纯二层网段必须配★
ip igmp snooping vlan 10 querier address 192.168.10.254
ip igmp snooping vlan 10 immediate-leave         ! Fast Leave，仅端口下单用户时启用
ip igmp snooping vlan 10 mrouter interface Gi0/1 ! 手工指定路由器端口

! ── 排错命令 ──
show ip igmp groups                              ! ★组成员表★
show ip igmp interface Vlan10                    ! 查询器身份、版本、定时器
