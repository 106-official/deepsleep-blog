...
1. **[01-原理与报文](01-原理与报文.md)** — SMTP 命令集与响应码、信封与报文头的区别、MIME 结构、完整投递时序图。
2. **[02-实战与排错](02-实战与排错.md)** — Wireshark 抓包过滤、telnet/openssl 手工发信、退信码解读、开放中继与鉴权失败排查、与 POP3/IMAP 对比速查。
