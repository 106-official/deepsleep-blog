...
window.CARDARENA_DATA = (function () {
  ...
  const ROLE_POOL = [
    { id: 'r1', name: '守序者', title: '宫廷侍卫长', intro: '沉稳的防线，每回合恢复少量生命', maxHealth: 20, attack: 2,
      passive: { type: 'heal', target: 'ally_hero', value: 1 },
      deck: ['c1', 'c2', 'g-m1', 'g-m2', 'g-m5', 'g-s1'] },
    { id: 'r2', name: '仲裁者', title: '大殿法官', intro: '以攻代守，己方随从获得额外攻击', maxHealth: 18, attack: 3,
      passive: { type: 'buff', target: 'ally_minion', attack: 1 },
      deck: ['c3', 'c4', 'g-m1', 'g-m3', 'g-m4', 'g-s1'] },
    { id: 'r3', name: '预言家', title: '宫廷占星师', intro: '洞悉先机，每回合多抽一张牌', maxHealth: 18, attack: 1,
      passive: { type: 'draw', target: 'none', value: 1 },
      deck: ['c5', 'c6', 'g-m1', 'g-m4', 'g-m7', 'g-s3'] },
    { id: 'r4', name: '守夜人', title: '夜巡统领', intro: '坚实的壁垒，随从获得额外生命', maxHealth: 22, attack: 2,
      passive: { type: 'buff', target: 'ally_minion', health: 1 },
      deck: ['c7', 'c8', 'g-m2', 'g-m5', 'g-m7', 'g-s2'] },
    { id: 'r5', name: '爆破手', title: '军械监制', intro: '高攻脆弱，每回合灼烧敌方随从', maxHealth: 16, attack: 4,
      passive: { type: 'damage', target: 'enemy_minion', value: 1 },
      deck: ['c9', 'c10', 'g-m1', 'g-m3', 'g-m6', 'g-s4'] },
    { id: 'r6', name: '召集者', title: '禁军教头', intro: '源源不断，每回合召唤小兵', maxHealth: 20, attack: 1,
      passive: { type: 'summon', target: 'none', cardId: 'c17' },
      deck: ['c11', 'c12', 'g-m1', 'g-m4', 'g-m7', 'g-s3'] },
    { id: 'r7', name: '守望者', title: '瞭望塔主', intro: '远程压制，每回合灼烧敌方角色', maxHealth: 20, attack: 3,
      passive: { type: 'damage', target: 'enemy_hero', value: 1 },
      deck: ['c13', 'c14', 'g-m2', 'g-m5', 'g-m8', 'g-s2'] },
    { id: 'r8', name: '影行者', title: '密探之首', intro: '攻血双修的刺客，随从全面强化', maxHealth: 16, attack: 3,
